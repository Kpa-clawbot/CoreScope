...
```bash
grep -nEi 'YOUR_NAME|YOUR_HANDLE|YOUR_PHONE|RFC1918_IPS|PROD_VM_IP|STAGING_VM_IP|/your/home/|<deploy-user>@|api[_-]?key|YOUR_KEY_FRAGMENT' docs/release-notes/vX.Y.Z.md \
