...
- Test: tighten slideover row selector to avoid the virtual-scroll spacer race. (#1663, e74e8607)
...
Test plan: `workspace-meshcore/test-plans/v3.8.4-cdp-test-plan.md` (93 tests across 16 sections)
...
```
git tag -a v3.8.4 e74e8607 -m "v3.8.4"
```
