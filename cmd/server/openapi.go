...
func routeDescriptions() map[string]routeMeta {
	return map[string]routeMeta{
		...
		"GET /api/healthz":            {Summary: "Readiness check", Description: "Returns readiness state plus background initialization and backfill progress.", Tag: "admin"},
		...
		"GET /api/perf/io":            {Summary: "Disk I/O performance statistics", Description: "Returns server and ingestor process disk I/O rates when available.", Tag: "admin"},
		"GET /api/perf/sqlite":        {Summary: "SQLite performance statistics", Description: "Returns SQLite WAL, page, cache, and hit-rate diagnostics.", Tag: "admin"},
		"GET /api/perf/write-sources": {Summary: "Ingestor write source statistics", Description: "Returns per-source write counters published by the ingestor stats file.", Tag: "admin"},
		...
		"GET /api/dropped-packets":    {Summary: "List dropped packets", Description: "Returns recently dropped packets for authenticated operator diagnostics.", Tag: "admin", Auth: true},
		...
		"GET /api/nodes/{pubkey}/battery":    {Summary: "Get node battery history", Description: "Returns battery telemetry for a single node.", Tag: "nodes"},
		"GET /api/nodes/clock-skew":          {Summary: "Get fleet clock skew", Description: "Returns clock skew estimates for nodes across the fleet.", Tag: "nodes"},
		"GET /api/nodes/{pubkey}/clock-skew": {Summary: "Get node clock skew", Description: "Returns clock skew details for a single node.", Tag: "nodes"},
		...
		// Analytics
		"GET /api/analytics/roles":           {Summary: "Role analytics", Description: "Returns role distribution and role-specific network analytics.", Tag: "analytics"},
		...
		"GET /api/observers/clock-skew":      {Summary: "Get observer clock skew calibrations", Description: "Returns observer calibration values used for clock skew detection.", Tag: "observers"},
		...
		"POST /api/paths/inspect":    {Summary: "Inspect a path", Description: "Scores candidate node paths for a list of hash prefixes and optional context.", Tag: "analytics"},
