	...
	return map[string]interface{}{
		"Node": map[string]interface{}{
			...
			"properties": map[string]interface{}{
				...
				"estimated_lat":               map[string]interface{}{"type": "number", "nullable": true, "description": "Node detail endpoint only, set only when lat/lon is null: an approximate position from the same neighbor-centroid estimate (geo-sanity-filtered via Config.NeighborMaxEdgeKm) that backs Position-Fix Coverage Gaps and View Path's approx markers."},
